<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="<?= base_url('admin') ?>">StemApp</a>
        </div>
        <div class="sidebar-brand sidebar-brand-sm">
            <a href="<?= base_url('admin') ?>">SM</a>
        </div>
        <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
                ...
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="<?= base_url('admin') ?>">Dashboard</a></li>
                </ul>
            </li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="<?= base_url('admin/siswa') ?>">Data siswa</a></li>
                    <li><a class="nav-link" href="<?= base_url('admin/guru') ?>">Data guru</a></li>
